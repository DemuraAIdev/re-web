...
function NavItem({ href, text }: { href: string, text: string }) {
    ...
    return (
        <Link
            ...
            className={
                isActive
                    ? "rounded-lg p-1 font-semibold text-black transition-all hover:scale-125 hover:bg-gray-200 hover:text-black dark:text-white  dark:hover:bg-gray-800 dark:hover:text-white sm:px-3 sm:py-2 md:inline-block border-dashed  border border-gray-500"
